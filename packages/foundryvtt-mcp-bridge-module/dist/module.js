...
var identifierSchema = external_exports.string().min(1).max(200);
var maybeStringSchema = external_exports.string().min(1).max(500).optional();
var jsonValueSchema = external_exports.lazy(
  () => external_exports.union([external_exports.string(), external_exports.number(), external_exports.boolean(), external_exports.null(), external_exports.array(jsonValueSchema), external_exports.record(jsonValueSchema)])
);
...
var documentTypeSchema = external_exports.enum(DOCUMENT_TYPES);
var folderTypeSchema = external_exports.enum(FOLDER_TYPES);
var toolNameSchema = external_exports.enum(TOOL_NAMES);
var readToolNameSchema = external_exports.enum(READ_TOOL_NAMES);
var writeToolNameSchema = external_exports.enum(WRITE_TOOL_NAMES);
var controlToolNameSchema = external_exports.enum(CONTROL_TOOL_NAMES);
var documentRefSchema = external_exports.object({
...
var flagChangeSchema = external_exports.object({
  namespace: external_exports.string().min(1).max(100).regex(/^[a-zA-Z0-9._-]+$/).default(MODULE_FLAG_NAMESPACE),
  key: external_exports.string().min(1).max(100).regex(/^[a-zA-Z0-9._-]+$/),
  value: jsonValueSchema
}).strict();
var systemChangeSchema = external_exports.object({
  path: external_exports.string().min(1).max(200).regex(/^[a-zA-Z0-9._-]+$/),
  value: jsonValueSchema
}).strict();
var prototypeTokenSubsetSchema = external_exports.object({
  actorLink: external_exports.boolean().optional(),
  displayBars: external_exports.number().int().min(0).max(60).optional(),
  displayName: external_exports.number().int().min(0).max(60).optional(),
  disposition: external_exports.number().int().min(-1).max(1).optional(),
  name: external_exports.string().min(1).max(200).optional(),
  vision: external_exports.boolean().optional()
}).strict().optional();
var journalPageInputSchema = external_exports.object({
  name: external_exports.string().min(1).max(200),
  textContent: external_exports.string().min(1)
}).strict();
var journalPageUpdateInputSchema = external_exports.object({
  name: external_exports.string().min(1).max(200),
  pageId: identifierSchema.optional(),
  textContent: external_exports.string().min(1)
}).strict();
var writeControlSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  requestContext: requestContextSchema
}).strict();
var findDocumentsInputSchema = external_exports.object({
  documentTypes: external_exports.array(documentTypeSchema).min(1).max(8).optional(),
  folderId: identifierSchema.optional(),
  includeContent: external_exports.boolean().default(false),
  limit: external_exports.number().int().min(1).max(100).default(25),
  query: external_exports.string().min(1).max(200).optional(),
  requestContext: requestContextSchema
}).strict();
var getDocumentInputSchema = external_exports.object({
  includeContent: external_exports.boolean().default(true),
  ref: documentRefSchema,
  requestContext: requestContextSchema
}).strict();
var listFoldersInputSchema = external_exports.object({
  documentType: folderTypeSchema.optional(),
  parentId: identifierSchema.optional(),
  requestContext: requestContextSchema
}).strict();
var getSceneSummaryInputSchema = external_exports.object({
  includeNotes: external_exports.boolean().default(true),
  requestContext: requestContextSchema,
  sceneId: identifierSchema.optional(),
  sceneName: external_exports.string().min(1).max(200).optional()
}).strict();
var createJournalEntryInputSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  flags: external_exports.array(flagChangeSchema).max(20).optional(),
  folderId: identifierSchema.optional(),
  pages: external_exports.array(journalPageInputSchema).min(1).max(20).optional(),
  requestContext: requestContextSchema,
  title: external_exports.string().min(1).max(200)
}).strict();
var updateJournalEntryInputSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  flags: external_exports.array(flagChangeSchema).max(20).optional(),
  folderId: identifierSchema.optional(),
  journalEntryId: identifierSchema,
  pages: external_exports.array(journalPageUpdateInputSchema).min(1).max(20).optional(),
  requestContext: requestContextSchema,
  title: external_exports.string().min(1).max(200).optional()
}).strict();
var createActorInputSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  flags: external_exports.array(flagChangeSchema).max(20).optional(),
  folderId: identifierSchema.optional(),
  img: external_exports.string().min(1).max(500).optional(),
  name: external_exports.string().min(1).max(200),
  prototypeToken: prototypeTokenSubsetSchema,
  requestContext: requestContextSchema,
  systemChanges: external_exports.array(systemChangeSchema).max(50).optional(),
  type: external_exports.string().min(1).max(100)
}).strict();
var updateActorInputSchema = external_exports.object({
...
var createActorItemInputSchema = external_exports.object({
  actorId: identifierSchema,
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  flags: external_exports.array(flagChangeSchema).max(20).optional(),
...
var updateActorItemInputSchema = external_exports.object({
  actorId: identifierSchema,
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  flags: external_exports.array(flagChangeSchema).max(20).optional(),
...
var createSceneNoteInputSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  entryId: identifierSchema,
  flags: external_exports.array(flagChangeSchema).max(20).optional(),
  icon: external_exports.string().min(1).max(500).optional(),
...
var setDocumentFlagsInputSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300).optional(),
  dryRun: external_exports.boolean(),
  flags: external_exports.array(flagChangeSchema).min(1).max(20),
  ref: documentRefSchema,
  requestContext: requestContextSchema
}).strict();
var previewableChangeSchema = external_exports.discriminatedUnion("toolName", [
  external_exports.object({ payload: createJournalEntryInputSchema, toolName: external_exports.literal("create_journal_entry") }).strict(),
  external_exports.object({ payload: updateJournalEntryInputSchema, toolName: external_exports.literal("update_journal_entry") }).strict(),
  external_exports.object({ payload: createActorInputSchema, toolName: external_exports.literal("create_actor") }).strict(),
  external_exports.object({ payload: updateActorInputSchema, toolName: external_exports.literal("update_actor") }).strict(),
  external_exports.object({ payload: createActorItemInputSchema, toolName: external_exports.literal("create_actor_item") }).strict(),
  external_exports.object({ payload: updateActorItemInputSchema, toolName: external_exports.literal("update_actor_item") }).strict(),
  external_exports.object({ payload: createSceneNoteInputSchema, toolName: external_exports.literal("create_scene_note") }).strict(),
  external_exports.object({ payload: setDocumentFlagsInputSchema, toolName: external_exports.literal("set_document_flags") }).strict()
]);
var previewChangeInputSchema = external_exports.object({
  change: previewableChangeSchema,
  requestContext: requestContextSchema
}).strict();
var applyApprovedChangeInputSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300),
  requestContext: requestContextSchema
}).strict();
var auditMetadataSchema = external_exports.object({
  agentId: maybeStringSchema,
  agentName: maybeStringSchema,
...
var normalizedDocumentSummarySchema = external_exports.object({
  id: identifierSchema,
...
var normalizedDocumentSchema = normalizedDocumentSummarySchema.extend({
  flags: external_exports.record(jsonValueSchema).optional(),
  folderId: identifierSchema.optional(),
  ...
  system: external_exports.record(jsonValueSchema).optional()
});
var sceneSummarySchema = external_exports.object({
  active: external_exports.boolean(),
  height: external_exports.number().optional(),
  id: identifierSchema,
  name: external_exports.string(),
  notes: external_exports.array(normalizedDocumentSummarySchema),
  noteCount: external_exports.number().int().nonnegative(),
  width: external_exports.number().optional()
}).strict();
var changeResultDataSchema = external_exports.object({
  ...
  diff: external_exports.array(diffEntrySchema),
  dryRun: external_exports.boolean(),
  warnings: external_exports.array(external_exports.string())
}).strict();
var previewChangeDataSchema = external_exports.object({
  approvalToken: external_exports.string().min(20).max(300),
...
var applyApprovedChangeDataSchema = changeResultDataSchema.extend({
  approvalTokenUsed: external_exports.string().min(20).max(300),
  toolName: writeToolNameSchema
});
...
var bridgeJobSchema = external_exports.object({
  dryRun: external_exports.boolean(),
  jobId: identifierSchema,
  payload: external_exports.record(jsonValueSchema),
  requestId: identifierSchema,
  toolName: toolNameSchema
}).strict();
var bridgeJobResultSchema = external_exports.object({
  after: external_exports.record(jsonValueSchema).nullable(),
  before: external_exports.record(jsonValueSchema).nullable(),
  diff: external_exports.array(diffEntrySchema),
...
var findDocumentsOutputSchema = createEnvelopeSchema(
  external_exports.object({
    documents: external_exports.array(normalizedDocumentSummarySchema)
  }).strict()
);
...
var listFoldersOutputSchema = createEnvelopeSchema(
  external_exports.object({
    folders: external_exports.array(normalizedDocumentSummarySchema)
  }).strict()
);
...
async function executeOperation(toolName, payload, options) {
  try {
    ...
    const bridgeError = error instanceof BridgeError ? error : new BridgeError(ERROR_CODES.moduleError, error instanceof Error ? error.message : "Unknown module error", 500);
    return {
      after: null,
      before: null,
      diff: [],
