...
const tag = `v${version}`;
const zipPath = path.join(root, "dist", "module-release", `foundryvtt-mcp-bridge-module-v${version}.zip`);
...
function resolveGhBinary() {
  ...
  fail("GitHub CLI (gh) not found. Install it first, then re-run this command.");
}
